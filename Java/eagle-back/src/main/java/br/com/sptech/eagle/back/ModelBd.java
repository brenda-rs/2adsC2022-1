        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                conexaoSQL.getConexaoSQL().update("insert into medida_disco values "
                        + "(null, ?, ?, ?);", usoDeDisco, discoLivre, LocalDateTime.now());
                ...
                conexaoSQL.getConexaoSQL().update("insert into medida_cpu values "
                        + "(null, ?, ?, ?);", tempoCpu, processosCpu, LocalDateTime.now());
                ...
                conexaoSQL.getConexaoSQL().update("insert into medida_memoria values "
                        + "(null, ?, ?, ?);", usoRam, ramLivre, LocalDateTime.now());
...
//          Timer funciona com milissegundos, então 1000 ms = 1 segundo
    ...
    public String verificarUsuario(String email, String senha){
        ...
        List<VerificacaoUsuario> listaUsuario = conexaoSQL.getConexaoSQL().query("select "
